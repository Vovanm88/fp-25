...
let test_write_read_list_float_file () =
  ...
  check
    (list (float 0.0001))
    "Write-read list_float file roundtrip" read_value value
...
let test_write_read_multiple_chunks () =
  ...
  let bytes =
    Writer.write_chunk chunk1_id chunk1_data
...
let test_find_chunk () =
  ...
  let bytes =
    Writer.write_chunk chunk1_id chunk1_data
    @ Writer.write_chunk chunk2_id chunk2_data
    @ Writer.write_chunk chunk3_id chunk3_data
  in
...
let test_write_read_file_header_file () =
  ...
  let read_magic, read_version, remaining =
    Reader.read_file_header_from_file filename
  in
...
let test_file_header_with_chunks () =
  ...
  let bytes =
    Writer.write_file_header magic version
    @ Writer.write_chunk chunk_id chunk_data
  in
  let read_magic, read_version, remaining = Reader.read_file_header bytes in
...
let test_io_integration_multiple_types () =
  ...
  let bytes =
    ...
    @ Writer.write_float float_val
    @ Writer.write_string string_val
    @ Writer.write_list_int32 list_int32_val
  in
    ...
    [
      ( "Int32",
        [
          ...
          test_case "Write-read int32 negative" `Quick
            test_write_read_int32_negative;
          ...
          test_case "Write-read int32 multiple" `Quick
            test_write_read_int32_multiple;
          test_case "Read int32 insufficient bytes" `Quick
            test_read_int32_insufficient_bytes;
        ] );
      ( "Int16",
        [
          ...
          test_case "Write-read int16 negative" `Quick
            test_write_read_int16_negative;
          ...
          test_case "Read int16 insufficient bytes" `Quick
            test_read_int16_insufficient_bytes;
        ] );
      ( "Uint8",
        [
          ...
          test_case "Write uint8 invalid negative" `Quick
            test_write_uint8_invalid_negative;
          test_case "Write uint8 invalid too large" `Quick
            test_write_uint8_invalid_too_large;
          test_case "Read uint8 insufficient bytes" `Quick
            test_read_uint8_insufficient_bytes;
        ] );
      ( "Float",
        [
          ...
          test_case "Write-read float negative" `Quick
            test_write_read_float_negative;
          ...
          test_case "Read float insufficient bytes" `Quick
            test_read_float_insufficient_bytes;
        ] );
      ( "String",
        [
          test_case "Write-read string basic" `Quick
            test_write_read_string_basic;
          test_case "Write-read string empty" `Quick
            test_write_read_string_empty;
          test_case "Write-read string unicode" `Quick
            test_write_read_string_unicode;
          test_case "Write-read string special chars" `Quick
            test_write_read_string_special_chars;
          test_case "Read string insufficient bytes" `Quick
            test_read_string_insufficient_bytes;
        ] );
      ( "List Int32",
        [
          test_case "Write-read list_int32 basic" `Quick
            test_write_read_list_int32_basic;
          test_case "Write-read list_int32 empty" `Quick
            test_write_read_list_int32_empty;
          test_case "Write-read list_int32 single" `Quick
            test_write_read_list_int32_single;
          test_case "Write-read list_int32 negative" `Quick
            test_write_read_list_int32_negative;
          test_case "Write-read list_int32 large" `Quick
            test_write_read_list_int32_large;
        ] );
      ( "List Float",
        [
          test_case "Write-read list_float basic" `Quick
            test_write_read_list_float_basic;
          test_case "Write-read list_float empty" `Quick
            test_write_read_list_float_empty;
          test_case "Write-read list_float single" `Quick
            test_write_read_list_float_single;
        ] );
      ( "Integration",
        [
          test_case "IO integration multiple types" `Quick
            test_io_integration_multiple_types;
        ] );
      ( "File I/O",
        [
          ...
          test_case "Write-read list_int32 file" `Quick
            test_write_read_list_int32_file;
          test_case "Write-read list_float file" `Quick
            test_write_read_list_float_file;
          test_case "Write-read bytes file" `Quick test_write_read_bytes_file;
          test_case "Write-read complex file" `Quick
            test_write_read_complex_file;
        ] );
      ( "Chunks",
        [
          test_case "Write-read chunk header" `Quick
            test_write_read_chunk_header;
          test_case "Write-read chunk" `Quick test_write_read_chunk;
          test_case "Write-read chunk file" `Quick test_write_read_chunk_file;
          test_case "Write-read multiple chunks" `Quick
            test_write_read_multiple_chunks;
      ...
      ( "File Headers",
        [
          ...
          test_case "Write-read file header file" `Quick
            test_write_read_file_header_file;
          test_case "File header with chunks" `Quick
            test_file_header_with_chunks;
        ] );
    ]
