...
let () =
  ...
  (* Read file *)
  let bytes =
    time_it "1. Read file (deserialize)" (fun () ->
  ...
  (* Deserialize *)
  let audio_file =
    time_it "2. Deserialize AudioFile" (fun () ->
  ...
  (* Decompress *)
  let _final =
    time_it "11. Decompress track" (fun () ->
